...
@Service
@Transactional
public class IstorijaTiketaServiceImpl implements IstorijaTiketaService {
    ...
    public IstorijaTiketaServiceImpl(IstorijaTiketaRepository ticketHistoryRepository,
